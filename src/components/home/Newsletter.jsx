...
export default function Newsletter() {
    return (<section className="gradient-primary">
      <div className="container-custom py-10 md:py-14">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="flex flex-col items-center justify-between gap-6 md:flex-row">
          <div>
          ...
          <div className="flex w-full max-w-md flex-col sm:flex-row md:w-auto">
            <input type="email" placeholder="Your email address" className="flex-1 rounded-t-lg bg-background px-5 py-3 text-foreground placeholder:text-muted-foreground focus:outline-none sm:rounded-l-lg sm:rounded-tr-none"/>
