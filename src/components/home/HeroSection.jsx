...
export default function HeroSection() {
  return (
    <section className="relative flex min-h-[460px] items-center overflow-hidden bg-surface-dark md:min-h-[60px]">
      <img
        src={heroBanner}
        alt="Hero Banner"
      ...
      <div className="container-custom relative z-10 py-16 sm:py-20">
        ...
        >
          ...
          <p className="mb-8 max-w-md text-base text-surface-dark-foreground/70 sm:text-lg">
            Discover premium electronics at unbeatable prices. Limited time
            offer on top brands.
          </p>
          <Link
            to="/shop"
