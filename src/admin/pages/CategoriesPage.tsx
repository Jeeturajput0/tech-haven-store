  ...
  return (
    <div className="space-y-8">
      <SectionTitle
        eyebrow="Catalog"
        title="Categories"
        description="A visual grid of collection groups with a premium, editorial-style presentation."
      />
      ...
      <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
        {initialCategories.map((category, index) => (
          <motion.button
            ...
            className="text-left"
            onClick={() => navigate(`/dashboard/products?category=${encodeURIComponent(category.title)}`)}
          >
