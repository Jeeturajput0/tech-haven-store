    ...
    <div className="overflow-hidden">
          ...
          <div className="grid items-center gap-10 lg:grid-cols-[1.2fr_0.8fr]">
            ...
            >
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <Link
                  to="/shop"
                  className="inline-flex items-center justify-center gap-2 rounded-xl gradient-primary px-6 py-3 font-heading text-sm font-bold text-primary-foreground transition-all hover:shadow-[var(--shadow-glow)]"
                >
                  Explore Products
                  <ArrowRight size={16} />
                </Link>
                <Link
                  to="/contact"
                  className="inline-flex items-center justify-center rounded-xl border border-border bg-background px-6 py-3 text-sm font-semibold text-foreground transition-colors hover:bg-secondary"
                >
                  Talk to Support
                </Link>
              </div>
      ...
      <section className="container-custom py-14 md:py-20">
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          className="rounded-[2rem] gradient-dark p-8 text-surface-dark-foreground md:p-10"
        >
