...
export default function ProductDetails() {
  ...
  const handleAddToCart = () => {
    for (let i = 0; i < qty; i++) cartStore.addToCart(product);
    ...
    <div className="container-custom py-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-16">
        ...
        <motion.div
          ...
          className="glass-card rounded-xl overflow-hidden bg-secondary/30 flex items-center justify-center p-8 aspect-square"
        >
        ...
        <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="flex flex-col justify-center">
          {product.badge && (
            <span className="inline-block w-fit px-3 py-1 rounded-full gradient-primary text-primary-foreground text-xs font-bold mb-4">
              {product.badge}
            </span>
          )}
          ...
          <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center">
            ...
            <button
              ...
              className="flex w-full flex-1 items-center justify-center gap-2 rounded-lg gradient-primary py-3 text-sm font-heading font-bold text-primary-foreground transition-all hover:shadow-[var(--shadow-glow)] disabled:opacity-40 sm:w-auto"
            >
