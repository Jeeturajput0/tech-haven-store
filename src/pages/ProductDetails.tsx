        ...
        <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="flex flex-col justify-center">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <button
              ...
              className="flex-1 py-3 rounded-lg gradient-primary text-primary-foreground font-heading font-bold text-sm flex items-center justify-center gap-2 hover:shadow-[var(--shadow-glow)] transition-all disabled:opacity-40"
            >
